...
const KanbanCard = ({ application, onClick }) => {
  ...
  return (
    <div
      ...
      onClick={onClick}
      className="cursor-pointer rounded-2xl border border-[#E7E7EF] bg-white p-4 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-md active:cursor-grabbing"
    >
      {/* Company */}
